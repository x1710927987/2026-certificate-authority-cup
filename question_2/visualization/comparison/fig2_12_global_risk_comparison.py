...
def main() -> None:
    ...
    fig.suptitle("Fig 2-12 Global thermal-risk indicator comparison across schemes", fontsize=14, y=0.98)
    fig.tight_layout()
    output_path = OUTPUT_DIR / "fig2_12_global_risk_comparison.png"
    fig.savefig(output_path, dpi=220, bbox_inches="tight")
    plt.close(fig)

    save_metadata(
        OUTPUT_DIR / "fig2_12_global_risk_comparison.json",
        {
            "figure_id": "fig2_12",
